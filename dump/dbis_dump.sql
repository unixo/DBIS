...
INSERT INTO `categories` VALUES (7,'Audio'),(6,'Computer Desktop'),(5,'Hard disk'),(3,'Keyboards'),(2,'Monitor'),(1,'Notebook'),(4,'PCCARD');
...
INSERT INTO `order_details` VALUES (1,3,1),(1,11,1),(2,2,1),(2,3,1),(2,5,1),(3,2,1),(3,6,1),(3,9,1),(4,6,1),(4,10,1),(4,11,1),(4,15,1),(5,6,1),(5,14,1);
...
INSERT INTO `orders` VALUES (1,1,'2010-01-20 18:31:24',800),(2,2,'2009-12-20 18:31:24',1515),(3,3,'2009-12-16 18:31:24',2190),(4,4,'2009-10-20 18:31:24',2300),(5,1,'2009-07-20 18:31:24',830);
...
INSERT INTO `users` VALUES (1,'Ferruccio','Vitale','unixo','*180222C0FDFC23751B7A5479FAD9D5CCA0D8A5F8','via del Sagittario, 17F','Rome'),(2,'Alessandro','Aldini','aaldini','*397EFB7A2C8193C4B59872894F27E63DC214FB64','via Saffi, 42','Urbino'),(3,'Erika','Pigliapoco','md','*7D2ABFF56C15D67445082FBB4ACD2DCD26C0ED57','via Saffi, 42','Urbino'),(4,'Alessandro','Bogliolo','boglio','*29095A22E1D7A8BA435088914071E259C161E341','via Saffi, 42','Urbino');
